...
> [!CAUTION] OBSERVAÇÃO: 
> - `map` retorna uma nova lista, não modifica a original.
> - Pode ser encadeado com outras operações como `filter`.
...
> [!CAUTION] OBSERVAÇÃO: 
> - `zip` combina elementos de mesma posição.
> - O resultado tem o tamanho da menor coleção.
...
> [!CAUTION] OBSERVAÇÃO: 
> - `associateWith`: elemento vira chave.
> - `associateBy`: elemento vira valor.
> - `associate`: lambda define chave e valor com `to`.
...
> - A coleção original não é modificada.