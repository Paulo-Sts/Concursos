...
## 2. Relações entre Tipos e Gêneros
...
### 2.3 Tipo Dissertativo Expositivo
...
### 2.4 Tipo Dissertativo Argumentativo
...
### 3.1 Principais Categorias de Gêneros Textuais

#### Informativo
- Função de informar sobre algo.
- Tem relação com o modo expositivo de organização textual.

#### Publicitário
- Promove produtos e serviços. Tem como objetivo vender.
- Para vender um determinado produto, o texto poderá descrevê-lo, criar slogans, orientar, entre outros.

#### Propagandístico
- Tem o objetivo de informar, alertar e fazer refletir.
- O texto propagandístico não tem como objetivo vender um produto, mas uma ideia, promovendo reflexões acerca de alguns assuntos, gerando uma mudança de comportamento nas pessoas. 
- Por exemplo, um cartaz sobre doação de órgãos pode ser considerado um texto propagandístico.

#### Normativo 
- Estabelece normas e regras.
- Uma lei ou um regimento interno de um órgão são exemplos de textos normativos.

#### Didático
- Tem o propósito de ensinar, transmitir um conhecimento.

#### Divinatório
- Prevê ou antecipa acontecimento futuro (base mística, transcendental).
- A leitura de um horóscopo, por exemplo, pode ser considerado um texto divinatório, ou seja, ele estabelece o que há de vir, "adivinha" o futuro.