...
## 1. Conceito
- Variações da língua conforme o contexto, objetivo e interlocutores da comunicação.
- Sinônimos: variações linguísticas, níveis de linguagem.
- O falante domina diferentes registros, adaptando-se a cada situação (poliglotia interna).
...
- Seleção Lexical (vocabulário):
  ...
  - Expressões idiomáticas informais: dá duro, disse-me-disse.
- Morfossintaxe (construção da frase):
  - Uso do verbo "ter" no sentido de "haver" ou "existir" (Tem muitos anos...).
  - Colocação pronominal inadequada (próclise no início de frase): Me disseram... (o formal seria Disseram-me...).
  - Omissão ou troca de preposições exigidas pela regência: chegar em casa (formal: chegar a casa).
  - Concordância verbal simplificada: Vamos se ver (formal: Vamos nos ver).
- Expressões e Estruturas:
  - Frases curtas e truncadas, típicas da fala.
  - Uso de expressões de intensidade coloquiais: tremenda bobagem.

#### 3.2 Marcas de Formalidade
- Obediência às regras gramaticais de concordância, regência e colocação pronominal.
