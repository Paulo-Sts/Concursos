...
- Ex:
  ...
  - Sujeito: "Esse assunto"
  - verbo: "interessa"
  - complemento: "a você"

#### Sujeito Posposto
- É quando o sujeito aparace após o verbo.
- Ex:
  - "Aconteceu aqui um terrível acidente."
  - Sujeito: "um terrível acidente"
  - verbo: "aconteceu"
  - complemento: "aqui"

#### Distância Núcleo Verbo
- É quando o núcleo do sujeito pode aparecer longe do verbo.
- Ex:
  - "Os problemas de atraso frequente na transposição de água do Rio São Francisco, principalmente na região do Ceará, acabaram."
  - Sujeito: "Os problemas de atraso frequente"
  - verbo: "acabaram"
  - complemento: "na transposição de água do Rio São Francisco, principalmente na região do Ceará,"

#### Sujeito Acusativo
- A Gramática Normativa, por regra, atribui aos pronomes retos a possibilidade de ser sujeito; contudo, há casos em que pronomes oblíquos átonos podem exercer essa função.
- Isso acontece em orações com os verbos deixar, mandar, fazer, ouvir, ver e sentir acompanhados de um complemento com verbo no infinitivo.
- Ex:
...
- Exemplo:
  - "É importante que todos compareçam." Análise: O que é importante? "Que todos compareçam".
...
- Exemplo:
  ...
  - Núcleo: (não existe)
- Ocorre com verbos impessoais como "haver", no sentido de existir, ocorrer, acontecer e suceder.
- Exemplo:
  - Ex: "Havia novos alunos presentes na sala."
  - Ex: "Houve terríveis acidentes nesta rodovia."
  - Ex: "Nunca haverá no Brasil um evento desse porte."