...
- Usado em perguntas (direta ou indiretamente).

| QUANDO USAR                                | EXEMPLO                               |
|--------------------------------------------|---------------------------------------|
| No início de perguntas diretas             | **Por que** você não veio?            |
| No meio de frases interrogativas indiretas | Não sei **por que** ele fez isso.     |
...
| QUANDO USAR                    | EXEMPLO                                               |
|--------------------------------|-------------------------------------------------------|
| Para dar uma causa, explicação | Não fui **porque** estava doente.                     |
...
| QUANDO USAR                                         | EXEMPLO                               |
|-----------------------------------------------------|---------------------------------------|
| No final de perguntas                               | Você não veio **por quê**?            |
...
| QUANDO USAR                              | EXEMPLO                                     |
|------------------------------------------|---------------------------------------------|
| Acompanhado de artigo (o, os, um)        | Quero entender o **porquê** da sua decisão. |
