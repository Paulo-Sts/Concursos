...
## 1. Definições Gerais
- A organização é a função que faz a distribuição das tarefas e dos recursos entre os membros organizacionais.
- Responsável por agrupar e estruturar os recursos para alcançar os objetivos de forma eficiente.
- O resultado principal do processo de organização é o desenho da Estrutura Organizacional.
...
- Nível Estratégico (Topo): Desenho da estrutura organizacional global.
- Nível Tático (Gerencial): Desenho departamental.
- Nível Operacional (Supervisão): Desenho de cargos e tarefas.

## 4. Representação Gráfica
- Organograma: Representação visual da estrutura, mostrando departamentos, cargos, hierarquia e a cadeia de comando.

## 5. Pontos-Chave para Concursos
- Resultado da Organização: Sempre lembre que o resultado final desta função é a Estrutura Organizacional.
- Diferenciação vs. Integração: A organização envolve dividir o trabalho (diferenciação) e, ao mesmo tempo, criar meios para coordená-lo (integração).
- Especialização: O excesso de especialização pode reduzir a produtividade a longo prazo devido ao fator humano (tédio/fadiga).