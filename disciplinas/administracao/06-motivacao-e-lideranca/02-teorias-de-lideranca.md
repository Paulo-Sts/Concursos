...
## 2. Teoria dos Traços
- Premissa: líder nasce líder (características inatas)
- Baseia-se em características pessoais e de personalidade
- Não teve validação científica
- Visão ultrapassada, mas ainda influencia práticas de gestão
...
- Combina preocupação com pessoas (eixo Y) e produção (eixo X) em escala 1-9
- Estilos principais:
  - Empobrecida (preocupação mínima com ambos)
  - Clube campestre (foco em relacionamentos)
  - Homem organizacional (equilíbrio mediano)
  - Autoridade (foco na produção)
  - Equipe (alto foco em ambos - considerado ideal)

## 6. Teorias Situacionais ou Contingenciais
- Premissa: não há estilo ideal único; depende da situação.
...
- Líder eficaz abre caminho para liderados atingirem objetivos.
- Considera fatores ambientais e características dos liderados.
