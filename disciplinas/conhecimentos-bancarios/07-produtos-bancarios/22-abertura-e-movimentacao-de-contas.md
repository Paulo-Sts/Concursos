...
|:-------------------|:------------------------------------|:-------------------------------------------------------------------|  
| Conta Salário      | Recebimento de salários/benefícios  | Aberta pelo empregador. Não tarifada. Não aceita outros depósitos. |  
| Conta Simplificada | Pessoas de baixa renda              | Limite: R$ 2.000 (saldo/depósitos mensais). Sem cheques. Gratuita. |  
| Conta Eletrônica   | Movimentação exclusivamente digital | Isenta de tarifas para TED/DOC. Pode ser aberta/encerrada online.  |  
| Poupança Social    | Auxílio emergencial                 | Documentação dispensada. Serviços essenciais gratuitos.            |  
