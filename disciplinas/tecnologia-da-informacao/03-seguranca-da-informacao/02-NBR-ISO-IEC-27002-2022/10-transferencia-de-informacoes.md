...
| TIPO DE CONTROLE | PROPRIEDADES DE SEGURANÇA | CONCEITOS DE SEGURANÇA CIBERNÉTICA | CAPACIDADES OPERACIONAIS | DOMÍNIOS DE SEGURANÇA |
|---|---|---|---|---|
...
- Informações confidenciais ou restritas devem manter rigorosamente o mesmo nível de tratamento e cuidado durante todo o processo de movimentação.
...
- Uso de técnicas criptográficas para informações sensíveis conforme previsto na norma;
- Controles para assegurar a rastreabilidade e o não repúdio;
- Manutenção de uma cadeia de custódia das informações durante o trânsito;
- Identificação de contatos apropriados (proprietários, agentes de segurança e custodiantes);
- Definição de responsabilidade cível em caso de incidentes de segurança, como perda de mídias físicas;
- Sistema de rotulagem acordado para informações críticas para garantir entendimento imediato e proteção;
...
- Exemplo ⟶ o descarte de HDs de computadores deve observar normas locais para evitar impactos ao meio ambiente.
- Requisitos legais adicionais, como assinaturas eletrônicas, devem ser considerados conforme leis, estatutos e contratos vigentes.

> [!TIP] DICAS: 
> - Atenção total: a transferência verbal também é objeto da norma. Não ignore o cuidado com o que é dito em ambientes públicos ou reuniões.
> - A rastreabilidade e o não repúdio são fundamentais tanto em transferências internas quanto externas.

> [!CAUTION] OBSERVAÇÃO: 
> - Pegadinha de prova: os custodiantes lidam diretamente com a informação, mas a responsabilidade (accountability) não é transferida para eles; ela permanece com o proprietário da informação.
> - A segurança da transferência não é dever exclusivo da TI; é uma responsabilidade compartilhada entre proprietários, gestores de risco e usuários.