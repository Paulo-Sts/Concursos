...
### 1.1 Centralizado x Descentralizado
...
## 2. Comandos e Fluxo de Trabalho
...
### 3.2 Analogia Didática
- Branch = ramos de uma árvore;
- Root = raiz (versão principal/base).

## 4. Git e Garantia de Qualidade de Software
