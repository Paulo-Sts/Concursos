...
> [!CAUTION] OBSERVAÇÃO: 
> - Swift é exclusivo para iOS/macOS; não roda nativamente em Android.
> - Xcode é a IDE oficial e funciona apenas no macOS.
...
> [!CAUTION] OBSERVAÇÃO: 
> - `var` = mutável; `let` = imutável.
> - Swift é fortemente tipado com inferência de tipo.
...
> - `Repeat...While` executa pelo menos uma vez antes de verificar.
...
> [!CAUTION] OBSERVAÇÃO: 
> - Protocolo em Swift equivale a Interface em Java.
> - `Equatable` exige implementação do operador `==` para comparação.