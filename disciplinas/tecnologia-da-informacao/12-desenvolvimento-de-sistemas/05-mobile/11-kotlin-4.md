...
> [!CAUTION] OBSERVAÇÃO: 
> - Arrays têm tamanho fixo em Kotlin.
> - `+=` em arrays cria uma nova cópia com o elemento adicionado.
...
> - Map: chaves únicas, valores podem repetir.
...
> [!CAUTION] OBSERVAÇÃO: 
> - Coleções mutáveis permitem adicionar, remover e modificar elementos.
> - Coleções imutáveis não permitem modificações.
