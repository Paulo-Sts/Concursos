...
- Incorpora:
  ...
  - Ferramentas específicas de tecnologia;
...
- Exigir o uso de recursos, linguagens e frameworks com segurança comprovada.
...
- A formação inicial é fornecida aos novos colaboradores após a contratação e é necessária a formação anual de atualização em todo o seu tempo de emprego na Microsoft.
- Os programadores e engenheiros também devem participar na formação específica de funções, para se manter informados sobre as noções básicas de segurança e tendências recentes no desenvolvimento seguro.
- Todos os funcionários como estagiários, funcionários contingentes, subcontratados e terceiros também são encorajados e recebem a oportunidade de procurar formação avançada de segurança e privacidade.
...
- O modelo irá evitar que as ameaças passem pelo design do produto e do sistema.
...
- Estas ferramentas incluem compiladores, ambientes de desenvolvimento seguros e verificações de segurança incorporados.
...
- Teste de fuzzing: é uma técnica de teste de software automatizada que envia dados aleatórios, inválidos ou inesperados como entrada para um sistema para ver se ele falha ou apresenta comportamentos anômalos.
...
### 4.7 Response
- Todos os serviços Microsoft são amplamente registrados e monitorados após o lançamento, identificando potenciais incidentes de segurança através de um sistema centralizado de monitoramento quase em tempo real.
